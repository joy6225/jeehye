...
<body>
                ...
                <div class="col-sm-12 col-md-10 col-lg-9 myInfo">
                    ...
                    <div class="tab-content">
                        <div id="info" class="tab-pane fade in active">
                            ...
                            <p>*표시는 필수 입력 표시입니다</p>
                            <form action="updateForm" method="post" id="updateForm">
                            <table class="table">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><fmt:formatDate value="${vo.regdate }" pattern="yyyy년 MM월dd일 hh:mm:ss"/></td>
                                    </tr>
                                </tbody>
                                </c:forEach>
                            </table>
	...
	<script>
		$("#updateBtn").click(function(){
			//1. 이름, 비밀번호, 비밀번호확인, 이메일, 폰, 주소의 공백검사
			//2. 비밀번호란은 8자리 이상, 16자리 이하로 처리 -> 비밀번호와 비밀번화확인란과 동일한지 확인
			//3. 나머지 조건은 공백이면 경고창
			//4. ajax요청을 통해서 json형식으로 updateUser요청으로 전송을 시켜서 업데이트처리
			//5. 업데이트가 성공이면 "정보가 수정되었습니다" 경고창으로 출력 후에 비밀번호와 비밀번화확인란을 공백처리
			//6. 업데이트가 실패라면 "정보 수정에 실패하였습니다" 경고창으로 출력 후에 비밀번호와, 비밀번호 확인란을 공백처리
			if($("#userPw").val().length > 16 || $("#userPw").val().length < 8){
