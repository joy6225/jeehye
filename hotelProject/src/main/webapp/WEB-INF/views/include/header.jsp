                            ...
                            <ul class="nav navbar-nav nav-ul">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                        ...
                                        <li><a href="${pageContext.request.contextPath }/hotel/hotelIntro">객실소개</a></li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                        <li><a href="${pageContext.request.contextPath }/review/reviewList">문의하기</a></li>
                                        <li><a href="#">이용후기</a></li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                        ...
                                        <li><a href="#tab1" class="tabLink">예약확인</a></li>
